...
elseif (!isset($_GET['code']) && !isset($_COOKIE['token']) && !isset($_COOKIE['refresh_token'])):
    ...
    ?><script>
     window.location.href = "https://accounts.spotify.com/authorize?client_id=3aabab9b39d94a038411b964540ac02d&response_type=code&redirect_uri=https://rayang.promo-24.codeur.online/ProjetData";
     </script><?php
  ...
  $data = [
    ...
    'code' => $_GET['code'],
    'redirect_uri' => "https://rayang.promo-24.codeur.online/ProjetData",
    'client_id' => "3aabab9b39d94a038411b964540ac02d",
    'client_secret' => $secret,
  ];
...
<body>
  ...
  <main>
          ...
          <script id="playlist-profile-template"  type="text/x-handlebars-template">
            <div class="carousel-item active">
              <div class="d-none d-lg-block">
                <div class="slide-box">
                  <div>
                    <a href="{{playlists.items.0.external_urls.spotify}}"><img src="{{playlists.items.0.images.0.url}}" alt="Second slide"></a>
                  </div>

                  <div> <a href="{{playlists.items.1.external_urls.spotify}}">
                    <img src="{{playlists.items.1.images.0.url}}" alt="Second slide">
                  </a>
                </div>

                <div>
                  <a href="{{playlists.items.2.external_urls.spotify}}">
                    <img src="{{playlists.items.2.images.0.url}}" alt="Second slide">
                  </a>
                </div>

                <div>
                  <a href="{{playlists.items.3.external_urls.spotify}}">
   ...
   <div class="d-none d-lg-block">
            <div class="slide-box">
              <div>
                <a href="{{playlists.items.8.external_urls.spotify}}"><img src="{{playlists.items.8.images.0.url}}" alt="Second slide"></a>
              </div>

              <div> <a href="{{playlists.items.9.external_urls.spotify}}">
                <img src="{{playlists.items.9.images.0.url}}" alt="Second slide">
              </a>
            </div>

            <div>
              <a href="{{playlists.items.10.external_urls.spotify}}">
                <img src="{{playlists.items.10.images.0.url}}" alt="Second slide">
              </a>
            </div>

            <div>
              <a href="{{playlists.items.11.external_urls.spotify}}">
                <img src="{{playlists.items.11.images.0.url}}" alt="Second slide">
              </a>
            </div>
            ...
            <div class="d-none d-md-block d-lg-none">
              <div class="slide-box">
                <div>
                  <a href="{{playlists.items.0.external_urls.spotify}}">
                ...
                <div>
                  <a href="{{playlists.items.1.external_urls.spotify}}">
                    <img src="{{playlists.items.1.images.0.url}}" alt="Second slide">
                  </a>
                </div>
...
<div class="d-none d-md-block d-lg-none">
              <div class="slide-box">
                <div>
                  <a href="{{playlists.items.6.external_urls.spotify}}">
                ...
                <div>
                  <a href="{{playlists.items.7.external_urls.spotify}}">
                    <img src="{{playlists.items.7.images.0.url}}" alt="Second slide">
                  </a>
                </div>

                <div>
                  <a href="{{playlists.items.8.external_urls.spotify}}">
                    <img src="{{playlists.items.8.images.0.url}}" alt="Second slide">
                  </a>
                </div>
      ...
      <div class="d-none d-md-block d-lg-none">
              <div class="slide-box">
                ...
                <div>
                  <a href="{{playlists.items.4.external_urls.spotify}}">
                    <img src="{{playlists.items.4.images.0.url}}" alt="Second slide">
                  </a>
                </div>

                <div>
                  <a href="{{playlists.items.5.external_urls.spotify}}">
   ...
   <div class="d-none d-lg-block">
            <div class="slide-box">
              <div>
                <a href="{{playlists.items.13.external_urls.spotify}}"><img src="{{playlists.items.13.images.0.url}}" alt="Second slide"></a>
              </div>

              <div> <a href="{{playlists.items.14.external_urls.spotify}}">
                <img src="{{playlists.items.14.images.0.url}}" alt="Second slide">
              </a>
            </div>

            <div>
              <a href="{{playlists.items.15.external_urls.spotify}}">
                <img src="{{playlists.items.15.images.0.url}}" alt="Second slide">
              </a>
            </div>

            <div>
              <a href="{{playlists.items.16.external_urls.spotify}}">
                <img src="{{playlists.items.16.images.0.url}}" alt="Second slide">
              </a>
            </div>
            ...
            <div class="d-none d-md-block d-lg-none">
              <div class="slide-box">
                <div>
                  <a href="{{playlists.items.9.external_urls.spotify}}">
                    <img src="{{playlists.items.9.images.0.url}}" alt="Second slide">
                  </a>
                </div>
